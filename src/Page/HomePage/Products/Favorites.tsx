  ...
  return (
    <div className="">
        <div className="pl-7 pt-5 text-2xl font-extrabold">
            <h1 className={`${theme === 'dark' ? 'text-white' : 'text-black'}`}>Favorite</h1>
        </div>
            ...
            {product.map((item) => (
                <div
                    ...
                    <div className="flex flex-col items-start w-full pl-3 gap-2">
                        <h1 className={`font-bold text-xl ${theme === 'dark' ? 'text-white' : 'text-black'}`}>{item.name}</h1>
                    ...
                    <button
                        ...
                        className={`text-2xl ${theme === 'dark' ? 'text-white' : 'text-black'} hover:text-red-500`}>
